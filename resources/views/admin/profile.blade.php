        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2 space-y-6">
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-5 border border-gray-100 dark:border-gray-700">
                        <h3 class="text-base font-black text-gray-900 dark:text-white mb-4 flex items-center">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-5 border border-gray-100 dark:border-gray-700">
                        <h3 class="text-base font-black text-gray-900 dark:text-white mb-4 flex items-center">
                            <svg class="w-4 h-4 mr-2 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
