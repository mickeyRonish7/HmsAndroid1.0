<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center gap-8">
            ...
            <a href="{{ route('admin.messages.sent') }}" class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 transition">
                            ...
                            @foreach($messages as $message)
                                <div class="flex items-start p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                                    ...
                                    <div class="flex-shrink-0 mr-4">
                                        ...
                                        @else
                                            <div class="w-12 h-12 rounded-full bg-green-200 dark:bg-green-900 flex items-center justify-center border-2 border-gray-300 dark:border-gray-600 text-green-600 dark:text-green-300 font-bold text-lg">
                                    ...
                                    <div class="ml-4 flex-shrink-0">
                                        <a href="{{ route('admin.messages.show', $message->id) }}" class="inline-flex items-center px-3 py-2 bg-blue-600 text-white text-xs font-semibold rounded-lg hover:bg-blue-700 transition">
                                            {{ __('Read') }}
                                        </a>
                                    </div>
                                </div>
