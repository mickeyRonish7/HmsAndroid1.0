<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center gap-8">
            ...
            <form action="{{ route('student.activity-logs.clear') }}" method="POST" onsubmit="return confirm('{{ __('Are you sure you want to clear your activity logs?') }}');" class="inline">
                @csrf
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @else
                        <div class="py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('Your activity history is empty.') }}</p>
                        </div>
                    @endif
                </div>
            </div>
